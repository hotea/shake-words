    ...
    <div className="relative w-full min-h-screen bg-[var(--color-background)] flex flex-col">
      ...
      <header className="flex items-center justify-between px-4 sm:px-6 py-3 z-20">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-white rounded-[var(--radius-md)] px-3 py-1.5 border border-[var(--color-border)] text-[var(--color-muted)] hover:text-[var(--color-foreground)] hover:border-[var(--color-primary)]/30 transition-all"
        >
          {inputMode === "gesture" ? (
            <>
